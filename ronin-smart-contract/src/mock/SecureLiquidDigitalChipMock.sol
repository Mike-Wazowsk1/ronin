...
contract SecureLiquidDigitalChipMock is ERC1155, Ownable {
    ...
    function mint(address[] memory recipients, uint256[] memory ids, uint256[] memory amounts) external onlyMinter {
    ...
    function burn(address account, uint256[] memory ids, uint256[] memory amounts) external onlyBurner {
